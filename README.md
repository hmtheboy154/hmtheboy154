...
```math
\ce{$\unicode[pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: 117.5px 127.25px; width: 130vw; opacity: 1; background: url('https://github.com/hmtheboy154/hmtheboy154/blob/master/hina.jpg?raw=true');]{x0000}$}
