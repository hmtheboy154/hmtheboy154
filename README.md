...
```math
\ce{$\unicode[display: block; position: absolute; top: 0; bottom: 0; left: 0; right: 0; background: url('hina.jpg') repeat; background-size: 117.5px 127.25px; opacity: 0.5; z-index: -1;]{x0000}$}
